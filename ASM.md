...
Interrupts jump to a manually set address.
there will be multiple interrupt addresses so that interrupts can be configured easier.
...
negative interrupt values are in-core interrupts as well.
